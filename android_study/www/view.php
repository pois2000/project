...
<?php
	for($i=0; $i<$rows; $i++){
		echo "<li class='thumb'><a href=index.php?id=".$eventIDt[$i].">";
		echo "<span class='list_img'><img width=100% height=100% src=user/".$member[$i][1]."/img/".$member[$i][5]." /></span>";
		echo "<sapn class='list_message'>".$member[$i][3]."</sapn>";
		echo "<span class='list_count'>".$member[$i][2]."요청, ".$member[$i][4]."명 참여중</span></a></li>";
	}
?>
</ul></div></div></div>
<div id=button>
