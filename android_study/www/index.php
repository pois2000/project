...
<body id="body">
  ...
  <div id="header">
    <div id="menu">
    <a href="view.php" class="btn"><i class="material-icons" style="font-size:35px">home</i></a>
    <a href="createnew.php" class="btn" target=_blank><i class="material-icons" style="font-size:35px">add_alert</i></a>
    <a href=<?php echo $share_msg?> class="btn"><i class="material-icons" style="font-size:35px">share</i></a>
